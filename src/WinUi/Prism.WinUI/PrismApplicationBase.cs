...
namespace Prism
{
    ...
    public abstract class PrismApplicationBase : Application
    {
        ...
        {
            ViewModelLocationProvider.SetDefaultViewModelFactory((view, type) => { return Container.Resolve(type); });
        }
        ...
        protected virtual void InitializeShell(UIElement shell)
        {
            ...
            {
                // In the WinUI 3 Desktop Application Model case, Window.Current is null
