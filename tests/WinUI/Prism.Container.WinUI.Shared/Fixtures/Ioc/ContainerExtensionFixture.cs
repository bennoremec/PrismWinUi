using Prism.Ioc;
using Prism.IocContainer.WinUI.Tests.Support.Mocks;
using Xunit;
using static Prism.DryIoc.WinUI.Tests.ContainerHelper;

namespace Prism.DryIoc.WinUI.Tests.Fixtures.Ioc;
