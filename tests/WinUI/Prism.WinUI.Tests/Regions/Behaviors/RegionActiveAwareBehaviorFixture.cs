...
public class RegionActiveAwareBehaviorFixture
{
    ...
    public void SetsIsActivePropertyOnIActiveAwareObjects()
    {
        ...
        var activeAwareObject = new ActiveAwareFrameworkElement();
    ...
    private class ActiveAwareObject : IActiveAware
    {
        public bool IsActive { get; set; }
        public event EventHandler IsActiveChanged;
    }

    private class ActiveAwareFrameworkElement : FrameworkElement, IActiveAware
    {
        public bool IsActive { get; set; }
        public event EventHandler IsActiveChanged;
    }
    ...
    [SyncActiveState]
    private class SyncedActiveAwareObject : IActiveAware
    {
        public bool IsActive { get; set; }
        public event EventHandler IsActiveChanged;
    }
    ...
    [SyncActiveState]
    private class SyncedActiveAwareObjectViewModel : IActiveAware
    {
        public bool IsActive { get; set; }
        public event EventHandler IsActiveChanged;
    }
