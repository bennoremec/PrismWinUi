...
public class RegionManagerFixture
{
    ...
    public void CanAddRegion()
    {
        ...
        var region2 = regionManager.Regions["MainRegion"];
    ...
    public void ShouldFailIfRegionDoesntExists()
    {
        ...
        {
            var regionManager = new RegionManager();
            var region = regionManager.Regions["nonExistentRegion"];
        });
    }
    ...
    {
        var regionManager = new RegionManager();
        var result = regionManager.Regions.ContainsRegionWithName("noRegion");
