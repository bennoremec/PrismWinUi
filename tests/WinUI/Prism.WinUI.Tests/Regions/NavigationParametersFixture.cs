...
{
    private const string _uri = "?id=3&name=brian";
    private const string _uriWithNoQuestionMarkDelimiter = "id=3&name=brian";
    private const string _uriWithArray = "color=red&color=white&color=blue";
    private const string _uriWithJQueryArray = "color[]=red&color[]=white&color[]=blue";
